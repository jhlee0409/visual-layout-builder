 ...
 * // ]
 */
export function exportToFiles(pkg: GenerationPackage): ExportedFile[] {
 ...
 */
function generateLayoutFile(pkg: GenerationPackage): string {
  const { schema, options } = pkg
